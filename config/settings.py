...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "accessforge"),
        "USER": os.getenv("POSTGRES_USER", "accessforge"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "accessforge"),
...
LOGIN_URL = "accessforge:login"
LOGIN_REDIRECT_URL = "accessforge:dashboard"
LOGOUT_REDIRECT_URL = "accessforge:login"
